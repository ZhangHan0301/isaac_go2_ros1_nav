...
class TerminationsCfg:
    ...
    reach_goal = DoneTerm(func=mdp.object_reached_goal,
                          params={"robot_cfg": SceneEntityCfg(name="robot"), 
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    #     offset=RayCasterCfg.OffsetCfg(pos=(0.0, 0.0, 20.0)),
    #     attach_yaw_only=True,
    #     pattern_cfg=patterns.GridPatternCfg(resolution=0.1, size=[5.0, 1.0]),
    #     debug_vis=True,
    #     mesh_prim_paths=["/World/ground"],
    # )
...
class NavigationEnvCfg_PLAY(NavigationEnvCfg):
    def __post_init__(self) -> None:
        # post init of parent
        super().__post_init__()
        terminations: TerminationsCfg = TerminationsCfg_Play()
